            ...
            if(type_file === 'slider'){
                ...
                for( let i = count_current_files ; i < count_of_files; i++) {
                    ...
                    reader.onload = function () {
                        ...
                        let row_div = $("<div class='row mb-3 slider_img_row'>", {
                        });
                        ...
                        let img_div = $("<div class='col-md-6 pr-md-1'>", {
                        ...
                        let input_title = $("<input>", {
                            ...
                            "name": `${input_file_slider_name}[title][${i}]`,
                            "class": "form-control"
                        });

                        let title = $('<div class="col-md-3 pr-md-1">', {
                            class: func_style_input_text,
                        });
                        ...
                        let input_alt = $("<input>", {
                            ...
                            "name": `${input_file_slider_name}[alt][${i}]`,
                            "class": "form-control"
                        });
                        let alt = $('<div class="col-md-1 pr-md-1">', {
                            class: func_style_input_text,
                        });
