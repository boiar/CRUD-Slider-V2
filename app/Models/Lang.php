...
class Lang extends Model
{
    ...
    protected $fillable = [
        ...
        'lang_img',
        'lang_is_active',
        'show_in_user_dashboard',
        'show_in_admin_dashboard'
    ];


    public static function getAllLangs($attrs = null){

       $langs = self::query()->where('lang_is_active','=', '1');

       if(isset($attrs['show_in_user_dashboard'])){
           $langs = $langs->where('show_in_user_dashboard', '=', 1);
       }

       if(isset($attrs['show_in_admin_dashboard'])){
           $langs = $langs->where('show_in_admin_dashboard', '=', 1);
       }

       return $langs->get()->toArray() ;
    }
