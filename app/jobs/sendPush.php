...
class sendPush implements ShouldQueue
{
    ...
    private $credentials = [
        "user"    => "AAAAE39eTKc:APA91bF6JplWnKj1bvMV7MulN80f5onc_ljbycJ2xvrEzbItMJAlON3myIXCaQxtz1LfCxK_Bi6FIMA-X-gr8h1ZXBovBLemKRkVN9MsWnWOHBulF4MZimi78BeH7D7-A5SGcu0g9g4J",
        "vendor"  => "AAAAE39eTKc:APA91bF6JplWnKj1bvMV7MulN80f5onc_ljbycJ2xvrEzbItMJAlON3myIXCaQxtz1LfCxK_Bi6FIMA-X-gr8h1ZXBovBLemKRkVN9MsWnWOHBulF4MZimi78BeH7D7-A5SGcu0g9g4J",
        "browser" => "",
    ];
    ...
    public function __construct($params)
    {
        ...
        */
        ...
        if(!in_array($toApp, ["browser", "vendor", "user"]))
        {
            $toApp = "browser";
        }
